...
### System Requirements
sFire Framework requires PHP 5.5.*, 5.6.*, 7.0.*, 7.1.*, 7.2.*, 7.3.* or later; we recommend using the latest PHP version whenever possible.


### Current version
The current version is 3.0.21 of the sFire Framework.
